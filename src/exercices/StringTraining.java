public class StringTraining {
	...
	public static String charToString(char value) {
		String charStr = Character.toString(value);
		return charStr;
	}
	...
	public static String upper(String string) {
		String strUpper = string.toUpperCase();
		return strUpper;
	}
	...
	public static String replaceChar(String string, char search, char replace) {
		...
		String str2 = Character.toString(replace);
		String alternative = string.replaceAll(str1, str2);
		return alternative;
	}
	...
	public static String replaceString(String string, String search, String replace) {
		String alt = string.replaceAll(search, replace);
		return alt;
	}
